                                ...
                                <div class="col-xs-12">
                                    <div>
                                        ...
                                        <select class="form-control" style="border: 1px solid #4c535c;" id="method" name="method">
                                           	<optgroup label="Layer4 BOTNET" style="color:#00bbff;">
														<?php
															$SQLGetLogs = $odb->query("SELECT * FROM `methods` WHERE `type` = 'l4b' ORDER BY `id` ASC");
														...
														?>
														  ...
														  <optgroup label="Layer7 BOTNET" style="color:purple;">
														<?php
															$SQLGetLogs = $odb->query("SELECT * FROM `methods` WHERE `type` = 'l7b' ORDER BY `id` ASC");
															while ($getInfo = $SQLGetLogs->fetch(PDO::FETCH_ASSOC)) {
																$name     = $getInfo['name'];
																$fullname = $getInfo['fullname'];
																echo '<option value="' . $name . '">'. $fullname . '</option>';
