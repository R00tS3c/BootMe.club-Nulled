...
<div class="row">
<div class="col-lg-8">
<div class="block block-link-shadow text-right" style="box-shadow: 0 -5px 25px -5px #42a5f5, 0 1px 5px 0 #42a5f5, 0 0 0 0 #42a5f5;">
...
<p class="font-w700" style="background-color: transparent; text-shadow: 1px 1px 2px #409ce7;"><span class="badge" style="background: linear-gradient(135deg, #262f38 0, #42a5f5 100%)!important;"></span> '.htmlspecialchars($title).'</p>
...
<div class="col-lg-4">
            <div class="block block-themed text-center" style="box-shadow: 0 -5px 25px -5px #42a5f5, 0 1px 5px 0 #42a5f5, 0 0 0 0 #42a5f5;">
                <div class="block block-rounded block-link-shadow text-center animated zoomIn" >
                ...
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-6">
                            ...
                            <div class="font-size-sm text-muted">Seconds: <?php echo $row['mbt']; ?></div>
                        </div>
                        <div class="col-6">
                            <div class="mb-5"><i class="fa fa-fire fa-2x text-primary"></i></div>
                            <div class="font-size-sm text-muted">Concurrents: <?php echo $row['concurrents']; ?></div>
                        </div>
                    </div>
                </div>
				    <div class="block-content">
	...
	<div class="col-lg-6">
<div class="block block-themed animated zoomIn" style="box-shadow: 0 -5px 25px -5px #42a5f5, 0 1px 5px 0 #42a5f5, 0 0 0 0 #42a5f5;">
<div style="background: linear-gradient(135deg, #262f38 0, #42a5f5 100%)!important;" class="block-header">
...
<div class="block-content block-content-dark">
	...
	<script type="text/javascript">
		var auto_refresh = setInterval(function() {
		  $("#getLastLogins").load("getLastLogins.php?count=15").fadeIn("slow");
		}, 5000);
   </script>
...
<div class="block-content block-content-dark">
	<script type="text/javascript">
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('4 3=2(0(){$(\'#1\').5(\'6.b?a=9\').7("8")},c);',13,13,'function|live_servers|setInterval|auto_refresh|var|load|ripserv|fadeIn|slow|15|count|php|5000'.split('|'),0,{}))
</script>
...
<div class="col-4">
<div class="font-size-sm font-w600 text-white-op text-uppercase">This Month</div>
<div class="font-size-h3 font-w600 text-white"><?php echo $count_month; ?></div>
...
<div class="col-4">
<div class="font-size-sm font-w600 text-white-op text-uppercase">Totally</div>
<div class="font-size-h3 font-w600 text-white"><?php echo $total_attacks; ?></div>
<!--<div class="font-w600 text-success">
...
<div class="modal-dialog modal-dialog-popout" role="document" style="box-shadow: 0 -5px 25px -5px #42a5f5, 0 1px 5px 0 #42a5f5, 0 0 0 0 #42a5f5;">
