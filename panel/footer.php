...
Created <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="#" target="_blank">RootSec</a>
</div>
<div class="float-left">
<a class="font-w600" href="#" target="_blank"></a> © <span class="js-year-copy">2019</span>
</div>
</div>
</footer>
        <script src="assets/js/22e/magnific-popup/jquery.magnific-popup.min.js"></script>
        <!-- Codebase Core JS -->
