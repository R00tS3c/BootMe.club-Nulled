                        ...
                        <form class="form-horizontal" method="post" onsubmit="return false;">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-material floating">
                                            <label for="time"><i class="fa fa-clock-o text-danger"></i> Time (120sec)</label>
											<br>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div>
                                        ...
                                        <select class="form-control" style="border: 1px solid #4c535c;" id="method" name="method">
                                           	<optgroup label="OVH BYPASSES" style="color:#00bbff;">
														<?php
															$SQLGetLogs = $odb->query("SELECT * FROM `methods` WHERE `type` = 'ovh' ORDER BY `id` ASC");
